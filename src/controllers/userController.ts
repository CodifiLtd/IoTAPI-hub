...
import { getUserByIdParamsSchema, userSchema } from '../schemas/user';
...
import type { User as UserRequest, GetUserByIdParams } from '../schemas/user';
...
export async function getUser(
  req: AuthenticatedRequest<GetUserByIdParams>,
